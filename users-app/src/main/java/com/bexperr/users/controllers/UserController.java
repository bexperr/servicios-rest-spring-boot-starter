package com.bexperr.users.controllers;
...
import com.bexperr.users.services.UserService;
...
public class UserController {
	...
	public ResponseEntity<User> authenticate(@RequestBody User user){
		return new ResponseEntity<>(service.getUsernameAndPassword(user.getUsername(), user.getPassword()),HttpStatus.OK);
	}
